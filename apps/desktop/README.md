...
Tauri shell. Set `AGENT_HQ_WEB_URL` to a deployed web origin for production
builds. The shell owns only native capabilities; the web app owns UI, state,
data, and the Three.js scene runtime.
