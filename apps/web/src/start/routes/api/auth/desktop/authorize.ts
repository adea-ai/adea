...
import { createStartRequestContext } from '../../../../../server/auth-request-context'
...
async function get(request: Request) {
  try {
    ...
    const authentication = await createNeonServerAdapter(createStartRequestContext).getSession()
    if (!authentication) {
