 ...
 * @returns {{dev: boolean, virtual: boolean, roomDesigner: boolean, characterDesigner: boolean, character: string | undefined, cameraViewMode: 'perspective' | 'orthographic' | undefined}}
 */
