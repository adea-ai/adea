...
| Adea destination                                                                                                                                          | Donor/path                                                                                                                    | Revision                                                                                       | Copyright/license                                                           | Reuse kind                                                                                                                                                                                                  | Modifications                                                                                                                                                                                                                                                                  | Tests                                                                                                   | NOTICE entry         |
| --------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- | -------------------- |
...
| `packages/dev-view/src/appearance/editor.ts`; `packages/dev-view/src/appearance/appearance-dialog.tsx`                                                    | Zeron `crates/ui/src/appearance.rs`                                                                                           | `30a9a9537c5ec96226c87f4bf349b6f77c5dfb59`                                                     | Copyright (c) 2026 Wing; MIT                                                | Substantial translation of the appearance state, unchanged-value setter semantics, and live palette re-resolution                                                                                           | Replaced GPUI globals with a Solid provider plus a snapshot draft editor; added the explicit save/revert/Reset contract, the validated custom accent picker, and reduced-transparency status                                                                                   | `packages/dev-view/tests/appearance-editor.test.ts`; `apps/web/e2e/appearance.spec.ts` in issue #425    | Zeron section        |
