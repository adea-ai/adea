...
organized by room-designer folder, including the expanded interior collection
plus separate `food/` and `drinks/` folders behind the combined Food & Drinks
editor category. Fully authored room scenes live in `@agent-hq/rooms`.
