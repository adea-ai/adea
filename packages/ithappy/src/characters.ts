...
// the same 44-joint skeleton. This module is intentionally self-contained:
// the HQ runtime calls these loaders directly instead of importing the Nifty
...
export type IthappyCharacterManifest = {
  id: string;
  label: string;
  assetUrl: string;
};
...
export function getIthappyCharacterManifest(id: string): IthappyCharacterManifest | undefined {
...
export async function loadIthappyCharacter(
  loader: GLTFLoader,
  id: string,
  ...
  const manifest = getIthappyCharacterManifest(id);
...
export async function loadIthappyCharacterAnimations(
  loader: GLTFLoader,
  id: string,
